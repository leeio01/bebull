...
export interface BEBULLInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface BEBULL extends BaseContract {
  connect(runner?: ContractRunner | null): BEBULL;
  waitForDeployment(): Promise<this>;

  interface: BEBULLInterface;
  ...
  ): TypedContractMethod<[_maxTx: BigNumberish], [void], "nonpayable">;
  getFunction(
